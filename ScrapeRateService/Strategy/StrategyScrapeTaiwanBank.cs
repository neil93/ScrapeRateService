        ...
        internal override string Execute()
        {
            for (int i = 0; i < 10; i++)
            {
                try
                {
                    ...
                    //公告時間
                    var time = doc.DocumentNode.SelectSingleNode("/html/body/div[1]/main/div[4]/p[2]/span[2]").InnerHtml;

                    //匯率表格
                    var nodes = doc.DocumentNode.SelectSingleNode("/html/body/div/main/div[4]/table").InnerHtml;
